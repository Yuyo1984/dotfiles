...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/yuyoyanase/.rbenv/versions/2.5.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/yuyoyanase/.rbenv/versions/2.5.0' '--with-openssl-dir=/usr/local/opt/openssl@1.1' '--enable-shared' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'LDFLAGS=-L/Users/yuyoyanase/.rbenv/versions/2.5.0/lib ' 'CPPFLAGS=-I/Users/yuyoyanase/.rbenv/versions/2.5.0/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/yuyoyanase/.rbenv/versions/2.5.0"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/Users/yuyoyanase/.rbenv/versions/2.5.0/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/yuyoyanase/.rbenv/versions/2.5.0/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/yuyoyanase/.rbenv/versions/2.5.0/lib  -fstack-protector -L/usr/local/lib"
